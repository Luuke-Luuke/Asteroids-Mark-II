...
# 3. you need t ocreate a meteor sprite class like the laser + meteor sprite group
# 4. the meteor movement should be a bit more random and the start pos is at the top of the window
